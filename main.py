...
def tokeninfo():
    ...
    if r.status_code == 200:
        ...
        print("\n")
        time.sleep(1)  
        print(Colorate.Diagonal(Colors.yellow_to_red,(f"[Username]: {user_name}")))
        print(Colorate.Diagonal(Colors.yellow_to_red,(f"[User ID]: {user_id}")))
        print(Colorate.Diagonal(Colors.yellow_to_red,(f"[Creation Date]: {creation_date}")))
        print(Colorate.Diagonal(Colors.yellow_to_red,(f"""[Avatar URL]: {avatar_url if avatar_id else ""}""")))
        print(Colorate.Diagonal(Colors.yellow_to_red,(f"[Token]: {token}")))
        print(Colorate.Diagonal(Colors.yellow_to_red,(f"[Nitro Status]: {has_nitro}")))
        print(Colorate.Diagonal(Colors.yellow_to_red,(f"[Nitro Information]:")))
        print(Colorate.Diagonal(Colors.yellow_to_red,(f"[Badges]{Fore.RESET}:      {badges}")))
        if has_nitro:
            print(Colorate.Diagonal(Colors.yellow_to_red,(f"[Expires in]: {days_left} day(s)")))
        else:
            print(Colorate.Diagonal(Colors.yellow_to_red,(f"[Expires in]: None day(s)\n")))

        printSlow(f"Contact Information:")
        print("\n")
        time.sleep(1)
        print(Colorate.Diagonal(Colors.blue_to_green,(f"""[Phone Number]: {phone_number if phone_number else ""}""")))
        print(Colorate.Diagonal(Colors.blue_to_green,(f"""[Email]: {email if email else ""}\n""")))
        ...
        print("\n")
        time.sleep(1)
        print(Colorate.Diagonal(Colors.green_to_blue,(f"[2FA/MFA Enabled]: {mfa_enabled}")))
        print(Colorate.Diagonal(Colors.green_to_blue,(f"[Flags]: {flags}")))
        print("\n")
        time.sleep(1)
        printSlow(f"Misc:")
        print("\n")
        time.sleep(1)
        print(Colorate.Diagonal(Colors.red_to_yellow,(f"[Locale]: {locale} ({language})")))
        print(Colorate.Diagonal(Colors.red_to_yellow,(f"[Email Verified]: {verified}")))
